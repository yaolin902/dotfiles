-- vim.cmd([[
-- highlight BookmarkSign ctermbg=2 ctermfg=0
-- highlight BookmarkAnnotationSign ctermbg=2 ctermfg=0
-- highlight BookmarkLine ctermbg=2 ctermfg=0
-- highlight BookmarkAnnotationLine ctermbg=2 ctermfg=0
-- ]])
vim.g.bookmark_sign = ""
