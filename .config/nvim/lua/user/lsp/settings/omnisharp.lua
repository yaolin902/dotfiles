-- Mono
local omnisharp_bin = "/home/y41/.local/share/nvim/mason/packages/omnisharp-mono/omnisharp/OmniSharp.exe"
local mono_bin = "/usr/bin/mono"
...
return {
	...
	cmd = { mono_bin, omnisharp_bin, "--languageserver", "--hostPID", tostring(pid) },
	omnisharp = {
		useModernNet = false,
